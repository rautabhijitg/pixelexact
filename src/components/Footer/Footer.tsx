    ...
    return (
        <footer className="site-footer">
            <div className="site-container site-footer__grid">
                ...
                <div><h3>Company</h3><Link href="/#about">About</Link><Link href="/#work">Case studies</Link><Link href="/#insights">Insights</Link></div>
                <div><h3>Services</h3><Link href="/services">All services</Link><Link href="/services/ux-product-design">UX &amp; Product Design</Link><Link href="/services/ui-design-systems">UI &amp; Design Systems</Link><Link href="/services/frontend-development">Development</Link></div>
                <div><h3>Contact</h3><p>Email, information required</p><p>Phone, information required</p></div>
            </div>
